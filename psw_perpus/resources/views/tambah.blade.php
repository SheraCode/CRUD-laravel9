    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-header">
                <h3><b>Tambah Data Mahasiswa</b></h3>
            </div>
            <div class="card-body">
                <form action="/tambahdata" method="post">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="number" class="form-control" id="exampleInputPassword1" name="nim">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label"><b>Fakultas</b></label>
                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="fakultas">
